...
!  diagnostic variables relating to light limitation function
   type (type_diagnostic_variable_id)       :: id_par,id_meanpar,
...
!  environmental dependencies
   ...
   type (type_dependency_id)                :: id_extc
...
!  environmental dependency variables
   real(rk)   :: uTm,dz,extc,Day,lat,swr
!  diagnostic dependency
